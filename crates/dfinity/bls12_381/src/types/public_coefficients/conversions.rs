...
use crate::types::{BivariatePolynomial, Polynomial, PublicCoefficients, PublicKey};
...
impl From<&BivariatePolynomial> for PublicCoefficients {
    fn from(polynomial: &BivariatePolynomial) -> Self {
        PublicCoefficients {
            coefficients: polynomial
                .coefficients
                .iter()
